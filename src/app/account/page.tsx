...
export default function AccountPage() {
  ...
  const icon = (name: string) => {
    ...
    switch (name) {
      case "orders":
        return <svg {...common}><path d="M20 7h-3a2 2 0 0 1-2-2V2" /><path d="M9 22h9a2 2 0 0 0 2-2V7l-5-5H9a2 2 0 0 0-2 2v3" /><path d="M3 12h6" /><path d="M3 16h6" /><path d="M3 8h2" /></svg>;
      case "reviews":
        return <svg {...common}><path d="m17 3-5 5-5-5" /><rect x="2" y="8" width="20" height="14" rx="2" /></svg>;
      case "wishlist":
      ...
      case "cart":
        return <svg {...common}><circle cx="8" cy="21" r="1" /><circle cx="19" cy="21" r="1" /><path d="M2.05 2.05h2l2.66 12.42a2 2 0 0 0 2 1.58h9.78a2 2 0 0 0 1.95-1.57l1.65-7.43H5.12" /></svg>;
      default:
        return null;
    }
  };
    ...
    <main className="min-h-screen bg-white dark:bg-gray-950">
      ...
      <div className="max-w-md mx-auto px-4 py-6">
        ...
        <button
          ...
          className="w-full text-center border border-red-500 text-red-500 py-3 rounded-md text-sm font-semibold hover:bg-red-50 dark:hover:bg-red-950/30 transition-colors mt-4"
        >
          Logout
        </button>
      </div>
