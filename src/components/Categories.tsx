  ...
  return (
    <section className="max-w-7xl mx-auto px-4 py-10">
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-7 gap-4">
        {categories.map((cat) => (
          <a key={cat.title} href="/shop" className="bg-gray-50 dark:bg-gray-900 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors rounded-xl p-4 flex items-center justify-between gap-2">
            <div>
              <h3 className="font-bold text-sm text-black dark:text-white">{cat.title}</h3>
