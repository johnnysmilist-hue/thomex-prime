...
export default function Header() {
  ...
  const { setOpen: setChatOpen, unread: chatUnread } = useChatWidget();
        ...
        <div className="relative flex items-center gap-3">
          ...
          <button onClick={() => setMobileMenuOpen(true)} className="shrink-0 w-9 h-9 rounded-full bg-gray-100 dark:bg-gray-900 flex items-center justify-center text-black dark:text-white" aria-label="Open menu">
            ...
            <button
              ...
              className="relative shrink-0 w-9 h-9 rounded-full bg-gray-100 dark:bg-gray-900 flex items-center justify-center text-black dark:text-white"
            >
